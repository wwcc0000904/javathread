...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    // CTV Patch Begin
    public static final int KEYCODE_CH_EXIT_TOP_APP = 289;

    public static final int KEYCODE_CH_BLUETOOTH_AUTOPAIR = 290;
    /**
     * redefine tv key
     */
    public static final int KEYCODE_TV_BEGIN                    = 1000;

    public static final int KEYCODE_EXIT                        = KEYCODE_TV_BEGIN;

    public static final int KEYCODE_MOUSE                       = KEYCODE_TV_BEGIN + 1;

    public static final int KEYCODE_PICTURE_MODE                = KEYCODE_TV_BEGIN + 2;

    public static final int KEYCODE_SOUND_MODE                  = KEYCODE_TV_BEGIN + 3;

    public static final int KEYCODE_SLEEP_MODE                  = KEYCODE_TV_BEGIN + 4;

    public static final int KEYCODE_COLORTEMP_MODE              = KEYCODE_TV_BEGIN + 5;

    public static final int KEYCODE_FREEZE_MODE                 = KEYCODE_TV_BEGIN + 6;

    public static final int KEYCODE_WINDOW_SWAP                 = KEYCODE_TV_BEGIN + 7;

    public static final int KEYCODE_AIR                         = KEYCODE_TV_BEGIN + 8;

    public static final int KEYCODE_CABLE                       = KEYCODE_TV_BEGIN + 9;

    public static final int KEYCODE_DVBC                        = KEYCODE_TV_BEGIN + 10;

    public static final int KEYCODE_DVBT                        = KEYCODE_TV_BEGIN + 11;

    public static final int KEYCODE_DVBS                        = KEYCODE_TV_BEGIN + 12;

    public static final int KEYCODE_AV                          = KEYCODE_TV_BEGIN + 13;

    public static final int KEYCODE_AV1                         = KEYCODE_TV_BEGIN + 14;

    public static final int KEYCODE_AV2                         = KEYCODE_TV_BEGIN + 15;

    public static final int KEYCODE_YPBPR                       = KEYCODE_TV_BEGIN + 16;

    public static final int KEYCODE_YPBPR1                      = KEYCODE_TV_BEGIN + 17;

    public static final int KEYCODE_YPBPR2                      = KEYCODE_TV_BEGIN + 18;

    public static final int KEYCODE_HDMI                        = KEYCODE_TV_BEGIN + 19;

    public static final int KEYCODE_HDMI1                       = KEYCODE_TV_BEGIN + 20;

    public static final int KEYCODE_HDMI2                       = KEYCODE_TV_BEGIN + 21;

    public static final int KEYCODE_HDMI3                       = KEYCODE_TV_BEGIN + 22;

    public static final int KEYCODE_HDMI4                       = KEYCODE_TV_BEGIN + 23;

    public static final int KEYCODE_VGA                         = KEYCODE_TV_BEGIN + 24;

    public static final int KEYCODE_MEDIA                       = KEYCODE_TV_BEGIN + 25;

    public static final int KEYCODE_MEDIA1                      = KEYCODE_TV_BEGIN + 26;

    public static final int KEYCODE_MEDIA2                      = KEYCODE_TV_BEGIN + 27;

    public static final int KEYCODE_MEDIA3                      = KEYCODE_TV_BEGIN + 28;

    public static final int KEYCODE_MEDIA_REPEAT_AB             = KEYCODE_TV_BEGIN + 29;

    public static final int KEYCODE_MEDIA_GOTO                  = KEYCODE_TV_BEGIN + 30;

    public static final int KEYCODE_MEDIA_PLAYMODE              = KEYCODE_TV_BEGIN + 31;

    public static final int KEYCODE_TV_CHANNEL_LIST             = KEYCODE_TV_BEGIN + 32;

    public static final int KEYCODE_TV_RECORD_LIST              = KEYCODE_TV_BEGIN + 33;

    public static final int KEYCODE_TV_SCHEDULE_LIST            = KEYCODE_TV_BEGIN + 34;

    public static final int KEYCODE_TV_FAVORITE_LIST            = KEYCODE_TV_BEGIN + 35;

    public static final int KEYCODE_TV_FAV                      = KEYCODE_TV_BEGIN + 36;

    public static final int KEYCODE_TV_FAV_ADD                  = KEYCODE_TV_BEGIN + 37;

    public static final int KEYCODE_TV_FAV_DEL                  = KEYCODE_TV_BEGIN + 38;

    public static final int KEYCODE_TV_FAV_CH_UP                = KEYCODE_TV_BEGIN + 39;

    public static final int KEYCODE_TV_FAV_CH_DOWN              = KEYCODE_TV_BEGIN + 40;

    public static final int KEYCODE_TV_HOLD                     = KEYCODE_TV_BEGIN + 41;

    public static final int KEYCODE_TV_SIZE                     = KEYCODE_TV_BEGIN + 42;

    public static final int KEYCODE_TV_SUBPAGE                  = KEYCODE_TV_BEGIN + 43;

    public static final int KEYCODE_TV_INDEX                    = KEYCODE_TV_BEGIN + 44;

    public static final int KEYCODE_TV_SUBTITLE                 = KEYCODE_TV_BEGIN + 45;

    public static final int KEYCODE_TV_CANCEL                   = KEYCODE_TV_BEGIN + 46;

    public static final int KEYCODE_TV_REVEAL                   = KEYCODE_TV_BEGIN + 47;

    public static final int KEYCODE_TV_TIME                     = KEYCODE_TV_BEGIN + 48;

    public static final int KEYCODE_TV_MIX                      = KEYCODE_TV_BEGIN + 49;

    public static final int KEYCODE_TV_AUDIO_TRACK              = KEYCODE_TV_BEGIN + 50;

    public static final int KEYCODE_TV_TIME_SHIFT               = KEYCODE_TV_BEGIN + 51;

    public static final int KEYCODE_TV_GINGA_BACK               = KEYCODE_TV_BEGIN + 52;

    public static final int KEYCODE_TV_ECO                      = KEYCODE_TV_BEGIN + 53;

    public static final int KEYCODE_TV_AUTO                     = KEYCODE_TV_BEGIN + 54;

    public static final int KEYCODE_TV_AUDIO_ONLY               = KEYCODE_TV_BEGIN + 55;

    public static final int KEYCODE_KEYPAD_EXTEND               = KEYCODE_TV_BEGIN + 56;

    public static final int KEYCODE_KEYPAD_EXTEND1              = KEYCODE_TV_BEGIN + 57;

    public static final int KEYCODE_TV_SOURCE_NUMBER            = KEYCODE_TV_BEGIN + 58;

    public static final int KEYCODE_TV_INFO_COLOR               = KEYCODE_TV_BEGIN + 59;

    public static final int KEYCODE_APP_RETAIL                  = KEYCODE_TV_BEGIN + 60;
     /**
     * redefine app key
     */

     public static final int KEYCODE_APP_BEGIN                  = 2000;

     public static final int KEYCODE_APP_NETFLIX                = KEYCODE_APP_BEGIN;

     public static final int KEYCODE_APP_YOUTUBE                = KEYCODE_APP_BEGIN + 1;

     public static final int KEYCODE_APP_FACEBOOK               = KEYCODE_APP_BEGIN + 2;

     public static final int KEYCODE_APP_TOONGOGGLES            = KEYCODE_APP_BEGIN + 3;

     public static final int KEYCODE_APP_SKYPE                  = KEYCODE_APP_BEGIN + 4;

     public static final int KEYCODE_APP_MIRACAST               = KEYCODE_APP_BEGIN + 5;

     public static final int KEYCODE_APP_KARAOK                 = KEYCODE_APP_BEGIN + 6;

     public static final int KEYCODE_APP_HOTSTAR                = KEYCODE_APP_BEGIN + 7;

     public static final int KEYCODE_APP_AMAZON                 = KEYCODE_APP_BEGIN + 8;

     public static final int KEYCODE_APP_TWITTER                = KEYCODE_APP_BEGIN + 9;

     public static final int KEYCODE_APP_PANDORA                = KEYCODE_APP_BEGIN + 10;

     public static final int KEYCODE_APP_VUDU                   = KEYCODE_APP_BEGIN + 11;

     public static final int KEYCODE_APP_ACCUWEATHER            = KEYCODE_APP_BEGIN + 12;

     public static final int KEYCODE_APP_CUSTOM1                = KEYCODE_APP_BEGIN + 13;

     public static final int KEYCODE_APP_CUSTOM2                = KEYCODE_APP_BEGIN + 14;

     public static final int KEYCODE_APP_CUSTOM3                = KEYCODE_APP_BEGIN + 15;

     public static final int KEYCODE_APP_CUSTOM4                = KEYCODE_APP_BEGIN + 16;

     public static final int KEYCODE_APP_CUSTOM5                = KEYCODE_APP_BEGIN + 17;

     public static final int KEYCODE_APP_CUSTOM6                = KEYCODE_APP_BEGIN + 18;

     public static final int KEYCODE_APP_CUSTOM7                = KEYCODE_APP_BEGIN + 19;

     public static final int KEYCODE_APP_CUSTOM8                = KEYCODE_APP_BEGIN + 20;

     public static final int KEYCODE_APP_CUSTOM9                = KEYCODE_APP_BEGIN + 21;

     public static final int KEYCODE_APP_CUSTOM10               = KEYCODE_APP_BEGIN + 22;

     public static final int KEYCODE_CUSTOM1                    = KEYCODE_APP_BEGIN + 23;

     public static final int KEYCODE_CUSTOM2                    = KEYCODE_APP_BEGIN + 24;

     public static final int KEYCODE_CUSTOM3                    = KEYCODE_APP_BEGIN + 25;

     public static final int KEYCODE_CUSTOM4                    = KEYCODE_APP_BEGIN + 26;

     public static final int KEYCODE_CUSTOM5                    = KEYCODE_APP_BEGIN + 27;

     public static final int KEYCODE_CUSTOM6                    = KEYCODE_APP_BEGIN + 28;

     public static final int KEYCODE_CUSTOM7                    = KEYCODE_APP_BEGIN + 29;

     public static final int KEYCODE_CUSTOM8                    = KEYCODE_APP_BEGIN + 30;

     public static final int KEYCODE_CUSTOM9                    = KEYCODE_APP_BEGIN + 31;

     public static final int KEYCODE_CUSTOM10                   = KEYCODE_APP_BEGIN + 32;

     /**
     * redefine factory key
     */

     public static final int KEYCODE_FAC_BEGIN                  = 3000;

     public static final int KEYCODE_FAC_MODE                   = KEYCODE_FAC_BEGIN;

     public static final int KEYCODE_FAC_MENU                   = KEYCODE_FAC_BEGIN + 1;

     public static final int KEYCODE_FAC_RESET                  = KEYCODE_FAC_BEGIN + 2;

     public static final int KEYCODE_FAC_SHIPPING_MODE          = KEYCODE_FAC_BEGIN + 3;

     public static final int KEYCODE_FAC_BURN                   = KEYCODE_FAC_BEGIN + 4;

     public static final int KEYCODE_FAC_BURN_ON                = KEYCODE_FAC_BEGIN + 5;

     public static final int KEYCODE_FAC_BURN_OFF               = KEYCODE_FAC_BEGIN + 6;

     public static final int KEYCODE_FAC_VOLUME_80              = KEYCODE_FAC_BEGIN + 7;

     public static final int KEYCODE_FAC_VOLUME_UP10            = KEYCODE_FAC_BEGIN + 8;

     public static final int KEYCODE_FAC_VOLUME_DOWN10          = KEYCODE_FAC_BEGIN + 9;

     public static final int KEYCODE_FAC_VOLUME_UP15            = KEYCODE_FAC_BEGIN + 10;

     public static final int KEYCODE_FAC_VOLUME_DOWN15          = KEYCODE_FAC_BEGIN + 11;

     public static final int KEYCODE_FAC_WHITE_BALANCE          = KEYCODE_FAC_BEGIN + 12;

     public static final int KEYCODE_FAC_EXIT_GUIDE             = KEYCODE_FAC_BEGIN + 13;

     public static final int KEYCODE_FAC_MAC_CODE               = KEYCODE_FAC_BEGIN + 14;

     public static final int KEYCODE_FAC_WHITE_PATTERN          = KEYCODE_FAC_BEGIN + 15;

     public static final int KEYCODE_FAC_BLUETOOTH              = KEYCODE_FAC_BEGIN + 16;

     public static final int KEYCODE_FAC_WIFI                   = KEYCODE_FAC_BEGIN + 17;

     public static final int KEYCODE_FAC_WIFI_CONNECT           = KEYCODE_FAC_BEGIN + 18;

     public static final int KEYCODE_FAC_ETHERNET               = KEYCODE_FAC_BEGIN + 19;

     public static final int KEYCODE_FAC_CIINFO                 = KEYCODE_FAC_BEGIN + 20;

     public static final int KEYCODE_FAC_ADC_ADJUST             = KEYCODE_FAC_BEGIN + 21;

     public static final int KEYCODE_FAC_PANEL_MODE             = KEYCODE_FAC_BEGIN + 22;

     /**
     * redefine customer factory key
     */

     //for changhong
     public static final int KEYCODE_CUS_FAC_BEGIN                          = 4000;

     public static final int KEYCODE_FAC_HKC_MENU                           = KEYCODE_CUS_FAC_BEGIN;

     public static final int KEYCODE_FAC_CH_M                               = KEYCODE_CUS_FAC_BEGIN + 1;

     public static final int KEYCODE_FAC_CH_S                               = KEYCODE_CUS_FAC_BEGIN + 2;

     public static final int KEYCODE_FAC_CH_SEARCH                          = KEYCODE_CUS_FAC_BEGIN + 3;

     public static final int KEYCODE_FAC_CHANNEL_INSTALLATION_MODE          = KEYCODE_CUS_FAC_BEGIN + 4;

     public static final int KEYCODE_FAC_CH_AUDIO_BALANCE                   = KEYCODE_CUS_FAC_BEGIN + 5;

     public static final int KEYCODE_FAC_CH_BARCODE                         = KEYCODE_CUS_FAC_BEGIN + 6;

     public static final int KEYCODE_FAC_CH_PRESET_CHANNEL                  = KEYCODE_CUS_FAC_BEGIN + 7;

     public static final int KEYCODE_FAC_CH_PRESET_CHANNEL_FROM_USB         = KEYCODE_CUS_FAC_BEGIN + 8;

     public static final int KEYCODE_FAC_CH_DATA_INFO                       = KEYCODE_CUS_FAC_BEGIN + 9;

     public static final int KEYCODE_FAC_CH_DATA_PORT_CHECK                 = KEYCODE_CUS_FAC_BEGIN + 10;

     public static final int KEYCODE_FAC_CH_UPDATE_FROM_USB                 = KEYCODE_CUS_FAC_BEGIN + 11;

     public static final int KEYCODE_FAC_CH_ARC_CEC_OPEN                    = KEYCODE_CUS_FAC_BEGIN + 12;

     public static final int KEYCODE_FAC_CH_INITIALIZE_DATA                 = KEYCODE_CUS_FAC_BEGIN + 13;

     public static final int KEYCODE_FAC_CH_QRCODE_DISPLAY                  = KEYCODE_CUS_FAC_BEGIN + 14;

     public static final int KEYCODE_FAC_CH_SWITCH_TEST_PATTERN             = KEYCODE_CUS_FAC_BEGIN + 15;

     public static final int KEYCODE_FAC_CH_MANUAL_SCAN                     = KEYCODE_CUS_FAC_BEGIN + 16;

     public static final int KEYCODE_FAC_CH_KEYPAD_CHECK                    = KEYCODE_CUS_FAC_BEGIN + 17;

     public static final int KEYCODE_FAC_CH_BACKLIGHT_MAX                   = KEYCODE_CUS_FAC_BEGIN + 18;

     public static final int KEYCODE_FAC_PC_AUTO                            = KEYCODE_CUS_FAC_BEGIN + 19;

     public static final int KEYCODE_FAC_MA_VOL080100                       = KEYCODE_CUS_FAC_BEGIN + 20;

     public static final int KEYCODE_FAC_MA_NETWORK_SETTING                 = KEYCODE_CUS_FAC_BEGIN + 21;

     public static final int KEYCODE_FAC_MA_MAC_INFO                        = KEYCODE_CUS_FAC_BEGIN + 22;

     public static final int KEYCODE_FAC_MA_AGING                           = KEYCODE_CUS_FAC_BEGIN + 23;

     public static final int KEYCODE_FAC_MA_ATV                             = KEYCODE_CUS_FAC_BEGIN + 24;

     public static final int KEYCODE_FAC_MA_DTV                             = KEYCODE_CUS_FAC_BEGIN + 25;

     public static final int KEYCODE_FAC_CH_BURN_KEY                        = KEYCODE_CUS_FAC_BEGIN + 26;

     private static final int LAST_KEYCODE = KEYCODE_FAC_CH_BURN_KEY;
    // CTV Patch End
